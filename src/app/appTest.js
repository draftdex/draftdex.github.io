...
const listOfQueries = [
    [["eq", "tier", "M1"]],                                                                                       // 1. Test number of M1 Pokemon
    [["eq", "tier", "M2"]],                                                                                       // 2. Test number of M2 Pokemon
    [["eq", "tier", "1"]],                                                                                        // 3. Test number of Tier 1 Pokemon
    [["eq", "tier", "2"]],                                                                                        // 4. Test number of Tier 2 Pokemon
    [["eq", "tier", "3"]],                                                                                        // 5. Test number of Tier 3 Pokemon
];
...
const listOfAnswers = [
    39,                        // 1. Test number of M2 Pokemon
    37,                        // 2. Test number of M1 Pokemon
    72,                        // 3. Test number of Tier 1 Pokemon
    85,                        // 4. Test number of Tier 2 Pokemon
    78,                        // 5. Test number of Tier 3 Pokemon
];
